//baby time lagega mujh tak ane ke liye mtx baap hai tera rey
...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'uzair', 'toilet.png');
    if (!existsSync(dirMaterial + "")) mkdirSync(dirMaterial, { recursive: true });
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/CFnari3.jpeg", path);
...
async function makeImage({ one, two }) {
    ...
    const __root = path.resolve(__dirname, "uzair");
