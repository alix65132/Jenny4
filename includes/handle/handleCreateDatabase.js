    ...
    return async function ({ event }) {
        ...
        var random2 = job[Math.floor(Math.random() * job.length)]
            ...
            if (!allUserID.includes(senderID) || !userName.has(senderID)) {
                ...
                logger(global.getText('handleCreateDatabase', 'newUser', chalk.hex("#" + random)(`New users: `) + chalk.hex("#" + random1)(`${singleData.name}`) + " || " + chalk.hex("#" + random2)(`${senderID}`)), '[ 𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 ]');
            }
