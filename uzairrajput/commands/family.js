  ...
  try {
    ...
    for(let id of idtv) {
      console.log(dem, chalk.green("FAMILY: ")+"drawing id's avt "+id);
        ...
        console.log(chalk.green("Family: ")+"Drawn avatar of id "+id);
        dem++;
