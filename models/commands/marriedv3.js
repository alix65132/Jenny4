...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("Please mention 1 person.", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "𝐊𝐢𝐬𝐢 𝐊𝐨 𝐀𝐚𝐳𝐦𝐚𝐧𝐞 𝐂 𝐃𝐚𝐫 𝐋𝐚𝐠𝐭𝐚 𝐇𝐚𝐢 🌸\n𝐊𝐢𝐬𝐢 𝐊𝐨 𝐀𝐩𝐧𝐚 𝐁𝐚𝐧𝐚𝐧𝐧𝐞 𝐂 𝐃𝐚𝐫 𝐋𝐚𝐠𝐭𝐚 𝐇𝐚𝐢 🥀\n𝐓𝐮𝐦 𝐀𝐩𝐧𝐢 𝐊𝐚𝐡𝐚𝐧𝐢𝐲𝐚 𝐒𝐮𝐧𝐚 𝐒𝐚𝐤𝐭𝐢 𝐇𝐨 𝐌𝐮𝐣𝐡𝐞 🤍\n𝐌𝐮𝐣𝐡𝐞 𝐀𝐩𝐧𝐞 𝐐𝐢𝐬𝐬𝐞 𝐁𝐚𝐭𝐚𝐧𝐞 𝐂 𝐃𝐚𝐫 𝐋𝐚𝐠𝐭𝐚 𝐇𝐚𝐢❣️\n\n‎🌸===『*★𝗖𝗿𝗲𝗱𝗶𝘁'𝘀 𒁍💐𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 💚✨", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
                                            }
