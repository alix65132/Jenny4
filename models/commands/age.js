...
module.exports.run = async function ({ event, args, api }) {
  ...
  // Nỗ não :>
  return api.sendMessage(`-Date of birth: ${input}\n\n-Number of years passed: ${nam} year \n-Number of months passed: ${thang} month \n-Number of weeks passed: ${tuan} week \n-Number of days passed: ${ngay} day \n-Hours passed: ${gio} hour \n-Minutes elapsed: ${phut} minute \n-Seconds elapsed: ${giay} second\n\n◈━━━━━━━━━━━━━━━━💚✨\n\n𝑴𝑨𝑫𝑬 𝑩𝒀\n\n◈━━━━━━━━━━━━━━━━💚✨\n\n𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 ◈ ──── 💚✨ `,event.threadID,event.messageID);
    }
