...
(typeof data.customLeave == "undefined") ? msg = "𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 𝐁𝐨𝐭 😇👈\n◈ ──────────────── 💚✨\n[⚜️] ◈ ──── 💚✨ {name} ◈ ──── 💚✨\n◈ ──────────────── 💚✨\n𝑲𝑶 𝑩𝑯𝑨𝑮𝑨 𝑫𝑰𝒀𝑨 🌝\n◈ ──────────────── 💚✨\n◈ ──── 💚✨ {type}  [⚜️] ◈ ──── 💚✨\n◈ ──────────────── 💚✨\n😒 𝐎𝐰𝐧𝐞𝐫 ➻ ◈ ──── 💚✨  𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 ☠️🏴‍☠️\n◈ ──────────────── 💚✨ •💜• {name} •💜• ◈ ──────────────── 💚✨\n𝑩𝑬𝑻𝑯𝑰 𝑯𝑨𝑾𝑨 𝑺𝑨𝑨 𝑻𝑯𝑨 𝑾𝑶 😥 𝑼𝑹𝑯𝑻𝑰 𝑷𝑨𝑻𝑨𝑵𝑮✨✨ 𝑺𝑨𝑨 𝑻𝑯𝑨 𝑾𝑶 ♥ 𝑲𝑨𝑯𝑨 𝑮𝑨𝒀𝑨 𝑼𝑺𝑬𝒀 𝑫𝑯𝑶𝑶𝑵𝑫𝑯𝑶 🤔🤔🤔\n◈ ──────────────── 💚✨\n\n[❤️‍🔥] 🖤🖤😥😥...Good {session} || {time}\n◈ ──────────────── 💚✨\n𝑪𝒓𝒆𝒅𝒊𝒕:- 𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 💚✨" : msg = data.customLeave;
