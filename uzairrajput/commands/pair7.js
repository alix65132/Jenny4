...
module.exports.run = async function ({ args, Users, Threads, api, event, Currencies }) {
  ...
  var background = [
  "https://i.imgur.com/IWuUhxW.jpeg"
  ];
  ...
  ctx.drawImage(baseAvt1, 4, 80, 236, 480);
  ctx.drawImage(baseAvt2, 242, 80, 235, 480);
  const imageBuffer = canvas.toBuffer();
  fs.writeFileSync(pathImg, imageBuffer);
  fs.removeSync(pathAvt1);
  fs.removeSync(pathAvt2);
  return api.sendMessage({ body: `𝐂𝐫𝐞𝐝𝐢𝐭 ➻    𝐌𝐫 𝐔𝐳𝐚𝐢𝐫 𝐑𝐚𝐣𝐩𝐮𝐭\n\n◈ ━━━━━━━━━━━━ 💚✨\n\n𝐋𝐨𝐠 𝐊𝐞𝐡𝐭𝐞 𝐇𝐚𝐢 𝐒𝐚𝐛𝐚𝐫 𝐊𝐚 𝐏𝐡𝐚𝐥 𝐌𝐢𝐭𝐡𝐚 𝐇𝐨𝐭𝐚 𝐇𝐚𝐢.. 🥰💗\n\n𝐋𝐢𝐤𝐢𝐧 𝐀𝐛 𝐒𝐚𝐛𝐚𝐫 𝐊𝐚𝐫𝐨 𝐓𝐰 𝐏𝐡𝐚𝐥 𝐊𝐢𝐬𝐢 𝐎𝐫 𝐊𝐚 𝐇𝐨 𝐉𝐚𝐭𝐚 𝐇𝐚𝐢..😹😹\n\n◈ ━━━━━━━━━━━━ 💚✨\n\n➻𝐂𝐨𝐧𝐠𝐫𝐚𝐭𝐮𝐥𝐚𝐭𝐢𝐨𝐧𝐬 ❤️🥳,\n\n ${name1} \n\n𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐩𝐚𝐢𝐫𝐞𝐝 𝐰𝐢𝐭𝐡 🫣💨\n\n ${name2}\n\n◈ ━━━━━━━━━━━━ 💚✨\n\n❤️🌸 𝐓𝐡𝐞 𝐨𝐝𝐝𝐬 𝐚𝐫𝐞:〘${tile}%〙`,
            mentions: [{
          tag: `${name2}`,
          id: id2
