...
"https://i.postimg.cc/v8PP9Rd0/distorted.jpg",
    ...
    var callback = () => api.sendMessage({ body: `𝐀𝐧𝐢𝐦𝐞 𝐩𝐫𝐨𝐟𝐢𝐥𝐞 𝐟𝐨𝐫 𝐲𝐨𝐮\n𝐓𝐚𝐠: 𝐀𝐧𝐢𝐦𝐞 𝐁𝐥𝐮𝐫\n\n◈━━━━━━━━━━━━━━━━💚✨\n\n𝑴𝑨𝑫𝑬 𝑩𝒀\n\n◈━━━━━━━━━━━━━━━━💚✨\n\n𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 ◈ ──── 💚✨`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
